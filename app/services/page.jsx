export const metadata = {
  ...
  openGraph: {
    title: 'Managed Immigration Technology Services | GlobalCodio',
    description: 'Full-service immigration technology management: platform deployment, AI agents, migration from legacy CMS, and ongoing operations. Your firm focuses on cases; we run the technology.',
  },
};
