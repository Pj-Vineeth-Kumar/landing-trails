...
import { Section, SmartLink } from '../components/PageKit.jsx';
...
export default function Blog() {
  ...
  return (
    <>
      <Seo
        title="Blog — GlobalCodio"
        description="Insights on AI in immigration technology, workflow automation, and what it means to run a fully managed technology operation for immigration law firms and corporate teams."
        path="/blog"
      />
