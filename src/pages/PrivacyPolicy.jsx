...
import { PageHero, Section } from '../components/PageKit.jsx';
...
export default function PrivacyPolicy() {
  ...
  return (
    <>
      <Seo
        title="Privacy Policy - GlobalCodio"
        description="GlobalCodio's privacy policy explains how we collect, use, share, and protect your personal information across our platform and services."
        path="/privacy-policy"
      />
