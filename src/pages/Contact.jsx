...
export default function Contact() {
  ...
  return (
    <>
      <Seo
        title="Contact GlobalCodio"
        description="Get in touch with the GlobalCodio team. Book a demo, ask a question, or learn how a fully managed immigration technology operation can work for your firm."
        path="/contact"
      />
