...
export const Nav = () => {
  ...
  const surface = scrolled
    ? {
        ...
        backdropFilter: 'blur(22px) saturate(200%) brightness(1.02)',
        WebkitBackdropFilter: 'blur(22px) saturate(200%) brightness(1.02)',
        border: '1px solid rgba(255,255,255,0.62)',
        boxShadow:
          'inset 0 1px 0 0 rgba(255,255,255,0.92), 0 10px 40px -14px rgba(11,19,36,0.18)',
      }
    : {
      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', gap: 10, alignItems: 'center', flexShrink: 0 }}>
            <a className="navlink" href="#" style={{ fontSize: scrolled ? 13 : 14, transition: 'font-size .35s cubic-bezier(.2,.7,.2,1)' }}>
              Sign in
            </a>
            <a
              href="#cta"
